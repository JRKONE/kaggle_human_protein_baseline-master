...
def test(test_loader,model,folds):
    sample_submission_df = pd.read_csv("/home/math5/dbzjc/dbzjc/sample_submission.csv")
...
def main():
    ...
    resume = False
    all_files = pd.read_csv("/home/math5/dbzjc/dbzjc/train.csv")
    #print(all_files)
    test_files = pd.read_csv("/home/math5/dbzjc/dbzjc/sample_submission.csv")
